...
const AdminCreateEvent = () => {
  ...
  const validate = () => {
    ...
    // Validate at least one ticket type has a price
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Filter out ticket types without prices
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl font-bold text-dark mb-8">Create New Event</h1>
            ...
            <Card>
              <div className="p-6">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  error={errors.venue}
                  placeholder="National Sports Stadium"
                  required
                />
            ...
            <Card>
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Set prices for different ticket categories. Leave blank for categories you don't want to offer.
                </p>
